...
* **`priv/static/tree-sitter-mf2.wasm`**, **`priv/static/highlights.scm`**, **`priv/static/injections.scm`**, and the grammar sources under `priv/grammar/` are copied from [`mf2_editor_extensions/tree-sitter-mf2`](https://github.com/elixir-localize/mf2_editor_extensions/tree/main/tree-sitter-mf2) (Apache-2.0). The WASM is compiled from those sources by `mix localize_mf2_editor.sync --build-wasm`.
